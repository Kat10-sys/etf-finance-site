(function () {
  ...
  const GLOSSARY = {
    ...
    'max-drawdown': 'The largest drop from a peak to a subsequent low point, before a new high was reached — a way to gauge the worst pain an investor would have felt holding through the decline.',
